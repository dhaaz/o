...
const NowPlaying = async () => {
    const res = await fetch(
        `https://api.themoviedb.org/3/movie/now_playing?api_key=${myApi}&language=id-IND&page=1`
    );
...
const popularnow = async () => {
    const res = await fetch(
        `https://api.themoviedb.org/3/movie/popular?api_key=${myApi}&language=id-IND&page=1`
    );
    const data = await res.json();
...
const Toprated = async () => {
    const res = await fetch(
        `https://api.themoviedb.org/3/movie/top_rated?api_key=${myApi}&language=id-IND&page=1`
    );
    const data = await res.json();
...
window.onload = function () {
    if (document.title.includes('Beranda')) {
